    ...
    return (
        <section className="flex flex-col">
            <div className="relative">
                <svg id="wave" className="rotate-180 transition-0" viewBox="0 0 1440 490" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
                            <stop stop-color="rgba(0, 153, 255, 1)" offset="0%"></stop>
                            <stop stop-color="rgba(0, 46.796, 255, 1)" offset="100%"></stop>
                        </linearGradient>
                    </defs>
                ...
                <h1 className="capitalize text-2xl font-bold absolute top-20 left-10 text-white flex flex-col">Welcome, <span className="text-secondary text-4xl">{user.name}</span></h1>
            </div>
            <div className="w-full max-w-6xl mx-auto flex gap-[20%] -translate-y-10">
                <Link href='/verify' className="flex-1 shadow-lg p-5 py-8 rounded-md hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-2">
                    <FiDownloadCloud />
                    Download Certificate
                </Link>
                <Link
                    href={{
                        pathname: '/student/dashboard/mycertificates',
                    }}
                    className="flex-1 shadow-lg p-5 py-8 rounded-md hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-2"
                >
                    <PiVaultBold />
