...
const Header = () => {
    return (
        <header className='w-full bg-gray-50/75 h-20 shadow-md flex items-center justify-center text-black sticky top-0 left-0 z-20 backdrop-blur-xl' >
            <div className="w-full max-w-6xl py-2 flex items-center justify-between">
                <Link href={'/'} className="flex items-center justify-center gap-2">
                    ...
                    <div className="text-left flex flex-col gap-0 justify-center">
                        <h1 className='text-xl leading-7 font-bold'>BlockCertify</h1>
